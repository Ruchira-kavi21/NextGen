        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 ">
            <div class="flex flex-col bg-gray-100 rounded-3xl p-6">
                ...
                <form action="#" method="POST">
                    ...
                    <input type="email" id="email" name="email" class="w-full p-3 mb-4 bg-white text-white rounded-md" placeholder="Enter Your Email Here">
                    
                    <label for="password" class="block text-sm font-bold">Password *</label>
                    <input type="password" id="password" name="password" class="w-full p-3 mb-4 bg-white text-white rounded-md" placeholder="Enter Your Password Here">
