...
<body class="bg-gray-900 text-white">
    <!-- Navigation Bar -->
    <nav class="bg-gray-900 text-white border-b border-red-600">
        <div class="container mx-auto flex justify-between items-center px-4 py-2">
            <div class="flex items-center">
                <img src="https://via.placeholder.com/40x40" alt="NextGen Computing Logo" class="h-10">
                <span class="ml-2 text-xl font-bold">NEXTGEN<br>COMPUTING</span>
            </div>
            <div class="flex space-x-8">
                <a href="#" class="py-2 px-4 hover:bg-gray-800">HOME</a>
                <a href="#" class="py-2 px-4 hover:bg-gray-800">DASHBOARD</a>
                <a href="#" class="py-2 px-4 hover:bg-gray-800">BEGINNER-IN BUILDING</a>
            </div>
    ...
    <script>
        ...
        function resetSelections(startingFrom) {
            ...
            for (let i = startIndex; i < selects.length; i++) {
                ...
                // Reset the corresponding selectedBuild entry
        ...
        document.getElementById('cpu-select').addEventListener('change', function() {
            ...
            if (cpuId) {
                ...
                .catch(error => {
                    ...
                    const motherboardSelect = document.getElementById('motherboard-select');
                    motherboardSelect.innerHTML = '<option value="">Error loading motherboards</option>';
                    motherboardSelect.disabled = true;
                });
            } else {
        ...
        document.getElementById('gpu-select').addEventListener('change', function() {
            ...
            if (gpuId && motherboardId) {
                ...
                .catch(error => {
                    ...
                    const ramSelect = document.getElementById('ram-select');
                    ramSelect.innerHTML = '<option value="">Error loading RAMs</option>';
                    ramSelect.disabled = true;
                });
            } else {
